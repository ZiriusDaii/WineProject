...
async function main() {
  ...
  console.log("\n💅 Services:");
  await seedService("Manicure Tradicional", 15000.0, 45, "Cuidado clásico para lucir uñas impecables con un acabado natural y elegante.", "Incluye limado y forma de uñas, remoción y tratamiento de cutículas, exfoliación suave de manos, esmaltado clásico con el color de preferencia e hidratación final.", "MANICURE");
  await seedService("Manicure Semipermanente", 25000.0, 60, "Esmalte de larga duración que mantiene tus uñas perfectas por semanas.", "Incluye preparación de la uña natural, base coat, capas de esmalte semipermanente en el color elegido, sellado con top coat, secado con lámpara UV/LED y retiro del esmalte anterior.", "MANICURE");
  await seedService("Pedicure Premium", 30000.0, 75, "Experiencia completa de cuidado y relajación para tus pies.", "Incluye remojo en agua tibia aromatizada, limado y forma de uñas, tratamiento de cutículas, exfoliación de pies, masaje relajante con crema hidratante y esmaltado profesional.", "PEDICURE");
  await seedService("Uñas Esculpidas en Gel", 45000.0, 120, "Extensiones de uñas personalizadas con gel UV para un look sofisticado.", "Incluye preparación completa de la uña, aplicación de tips o molde, construcción con gel UV, limado y perfilado profesional, diseño personalizado a elección y sellado con top coat de brillo.", "NAIL_ART");
